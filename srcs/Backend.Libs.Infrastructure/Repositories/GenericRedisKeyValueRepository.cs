...
namespace Backend.Libs.Infrastructure.Repositories;

public sealed class GenericRedisKeyValueRepository<TKey, TObject> : IKeyValueRepository<TKey, TObject>
    where TKey : notnull
    {
        ...
        public GenericRedisKeyValueRepository(ICacheClient multiplexer) : this(typeof(TObject).Name.ToLower(), multiplexer)
        {
        }

        private GenericRedisKeyValueRepository(string basePrefix, ICacheClient multiplexer)
        {
